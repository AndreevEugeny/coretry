...
namespace WebApplication5
{
    public partial class AdventureWorks2019Context : DbContext
    {
        ...
        public virtual DbSet<WebApplication5.Models.File> Files { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-9M9CF6C\\SQLEXPRESS;Database=AdventureWorks2019;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<WebApplication5.Models.File>(entity =>
            {
